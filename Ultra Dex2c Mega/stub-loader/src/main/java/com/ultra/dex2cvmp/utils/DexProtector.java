 ...
 *
 *  1. Native bootstrap — a separately loaded VM-protected library authenticates
 *     and decrypts the XChaCha20-Poly1305 libphantom blob before loading it.
 *
...
public class DexProtector {
    ...
    public void install(Context context) throws Exception {
        ...
        if (bundleBytes.length < 8) {
            throw new RuntimeException(k('b','a','d',' ','v','m','p'));
        }

        // ── Step 2: Bootstrap libphantom.so with the native VM loader ─────────
