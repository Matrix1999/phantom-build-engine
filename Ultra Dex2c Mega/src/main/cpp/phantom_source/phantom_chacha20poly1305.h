 ...
 *
 * ChaCha20-Poly1305 is used for the authenticated Phantom envelopes.  The
 * existing native-only DEX loading, key reconstruction, anti-dumper checks,
 * and wipe paths are unchanged.
 */
