 ...
 *     Bundle format: [4-byte version][4-byte shard count]
...
public class DexPacker {
    ...
    public static final String BOOTSTRAP_ARM64 = "libbootstrap_arm64.so";
    public static final String BOOTSTRAP_ARM   = "libbootstrap_arm.so";
    ...
    private void packInternal(File inputApk, File outputApk, File workDir,
        ...
        // Write bundle: [4-byte version][4-byte count]
        ...
        copyAssetToDir(ASSET_DIR + "/" + BOOTSTRAP_ARM64, new File(shardsDir, BOOTSTRAP_ARM64));
        copyAssetToDir(ASSET_DIR + "/" + BOOTSTRAP_ARM,   new File(shardsDir, BOOTSTRAP_ARM));
