...
public class ProtectViewModel extends AndroidViewModel {
    ...
    private boolean blockRootedEnabled;
    ...
    public ProtectViewModel(Application app) {
        ...
        blockRootedEnabled = prefs.getBoolean(KEY_BLOCK_ROOTED, true);
    ...
    public boolean isBlockRootedEnabled()           { return blockRootedEnabled; }
    public void    setBlockRootedEnabled(boolean v) {
        this.blockRootedEnabled = v;
        getApplication()
            .getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
